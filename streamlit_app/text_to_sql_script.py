...
eb_load = eb.load_local_vector_store(vector_store_path=r'/home/sagemaker-user/text-to-sql-for-athena/vector_store_client_product/23072024121127.vs')
...
# obj = Clientmodules.createS3Client().get_object(Bucket= 'bedrock-example-simonfong' , Key = 'llm-athena-output/athena_output/0370dabb-ba0d-4a6b-9f6a-b52e07ab9f6.csv')
# result = pd.read_csv(io.BytesIO(obj['Body'].read()), encoding='utf8')
# result.to_csv('test_results.csv',index=None)
